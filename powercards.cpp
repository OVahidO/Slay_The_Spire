...
PowerCard::PowerCard(QString name, int energyCost, QString path, QString description, bool requiresTarget, bool isExhaust, bool isRare, QGraphicsItem *parent)
...
Brutality::Brutality(QString path, QGraphicsItem *parent)
    : PowerCard("Brutality", 0, path, "At the start of your turn, lose 1 HP and draw 1 card.", false, false, true, parent) {}
...
DemonForm::DemonForm(QString path, QGraphicsItem *parent)
    : PowerCard("Demon Form", 3, path, "At the start of your turn gain 3 Strength", false, false, true, parent) {}
...
Metallicize::Metallicize(QString path, QGraphicsItem *parent)
    : PowerCard("Metallicize", 1, path, "At the end of your turn get 3 block", false, false, false, parent) {}
...
Berserk::Berserk(QString path, QGraphicsItem *parent)
    : PowerCard("Berserk", 0, path, "Gain 2 Vulnerable\nAt the start of your turn get 1 extra Energy", false, false, true, parent) {}
...
DarkEmbrace::DarkEmbrace(QString path, QGraphicsItem *parent)
    : PowerCard("Dark Embrace", 2, path, "Every time a card is Exhausted, draw a card", false, false, false, parent) {}
