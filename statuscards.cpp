...
StatusCard::StatusCard(QString name, int energyCost, QString path, QString description, bool isRare, bool isExhaust, bool requiresTarget, QGraphicsItem *parent)
...
BURN::BURN(QString path, QGraphicsItem *parent)
    :StatusCard("BURN", 0, path, "At the end of your turn\nif in hand: take 2 damage", false, false, false, parent) {}
