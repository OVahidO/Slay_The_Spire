...
StatusCard::StatusCard(QString name, int energyCost, QString path, QString description, bool isRare, bool requiresTarget, QGraphicsItem *parent)
...
DAZE::DAZE(QString path, QGraphicsItem *parent)
    :StatusCard("DAZE", 0, path, "", false, false, parent) {}
...
SLIME::SLIME(QString path, QGraphicsItem *parent)
    :StatusCard("SLIME", 1, path, "", false, false, parent) {}
...
WOUND::WOUND(QString path, QGraphicsItem *parent)
    :StatusCard("WOUND", 0, path, "", false, false, parent) {}
...
BURN::BURN(QString path, QGraphicsItem *parent)
    :StatusCard("BURN", 0, path, "At the end of your turn, if in hand: take 2 damage", false, false, parent) {}
