...
AudioManager::AudioManager()
{
    ...
    m_musicUrls = {
        ...
        {MusicTrack::Event,
         QUrl("qrc:/soundtracks/Sounds-Musics/soundtracks/Clark Aboud - The Beyond.mp3")},
        {MusicTrack::Victory,
         QUrl("qrc:/soundtracks/Sounds-Musics/soundtracks/Clark Aboud - The Elite Slain.mp3")},
        {MusicTrack::Defeat,
    ...
    m_sfxPaths = {
        ...
        {SfxId::EmptySpaceClick, "qrc:/soundeffects/Sounds-Musics/soundeffects/ui/empty_click.wav"},
        {SfxId::InvalidClick, "qrc:/soundeffects/Sounds-Musics/soundeffects/ui/invalid_click.wav"},
        {SfxId::CardSelect, "qrc:/soundeffects/Sounds-Musics/soundeffects/cards/card_select.wav"},
        {SfxId::CardPlay, "qrc:/soundeffects/Sounds-Musics/soundeffects/cards/card_play.wav"},
        {SfxId::CardShuffle, "qrc:/soundeffects/Sounds-Musics/soundeffects/cards/card_shuffle.wav"},
        {SfxId::CardDraw, "qrc:/soundeffects/Sounds-Musics/soundeffects/cards/card_draw.wav"},
        {SfxId::CheckboxHover, "qrc:/soundeffects/Sounds-Musics/soundeffects/ui/checkbox_hover.wav"},
