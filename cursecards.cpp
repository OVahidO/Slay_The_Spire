...
CurseCard::CurseCard(QString name, int energyCost, QString path, QString description, bool isRare, bool requiresTarget, QGraphicsItem *parent)
...
J_A_X::J_A_X(QString path, QGraphicsItem *parent)
    :CurseCard("J_A_X", 0, path, "Lose 3 HP - Gain 2 Strength", false, true, parent) {}
...
CurseOfTheBell::CurseOfTheBell(QString path, QGraphicsItem *parent)
    :CurseCard("CurseOfTheBell", 0, path, "You cannot remove this card from your deck", false, false, parent) {}
...
Regret::Regret(QString path, QGraphicsItem *parent)
    :CurseCard("Regret", 0, path, "Take 1 damage for every card in hand after your turn ends", false, false, parent) {}
