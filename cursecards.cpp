...
CurseOfTheBell::CurseOfTheBell(QString path, QGraphicsItem *parent)
    :CurseCard("CurseOfTheBell", 0, path, "You cannot remove this card from your deck", false, false, false, parent) {}
...
Regret::Regret(QString path, QGraphicsItem *parent)
    :CurseCard("Regret", 0, path, "Take 1 damage for every card in hand after your turn ends", false, false, false, parent) {}
